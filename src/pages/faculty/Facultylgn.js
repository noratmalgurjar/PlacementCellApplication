...
export class Facultylgn extends Component {
  constructor(){
    super();
    this.state = {
      username: '',
  ...
  flogin() {
    if(this.state.username && this.state.password){
      PostData('flogin',this.state).then((result) => {
...
<div class="container p-3 my-3 text-white col-md-6 ">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" name="username" onChange={this.onChange}  aria-describedby="emailHelp" placeholder="Enter email" />
            ...
            <button type="submit" class="btn btn-primary" value="Login" onClick={this.flogin}>Login</button>
